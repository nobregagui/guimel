...
export { CLIENTES_ABAS, CLIENTES_FILTROS, CLIENTE_FORMAS_PAGAMENTO, CLIENTE_SEGMENTOS, EMPTY_CLIENTE_FORM, ESTADOS_BR, FORMA_PAGAMENTO_LABEL } from '@/features/clientes/data/shared'
