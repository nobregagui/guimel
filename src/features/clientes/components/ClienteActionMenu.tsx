...
export interface ClienteActionMenuItem {
  id: string
  label: string
  onClick: () => void
  disabled?: boolean
...
interface ClienteActionMenuProps {
  items: ClienteActionMenuItem[]
  ariaLabel?: string
}

export function ClienteActionMenu({ items, ariaLabel = 'Ações' }: ClienteActionMenuProps) {
  ...
  const handleSelect = useCallback((item: ClienteActionMenuItem) => {
